...
- [8. 연산자](#8-연산자)
  - [8.1. 연산자의 종류](#81-연산자의-종류)
    ...
    - [8.1.6. 비트연산자](#816-비트연산자)
      - [8.1.6.1. `&`](#8161-)
        - [8.1.6.1.1. 예시](#81611-예시)
        - [8.1.6.1.2. 결과](#81612-결과)
- [9. 제어문](#9-제어문)
  - [9.0. 제어문의 구성](#90-제어문의-구성)
  - [9.1. 조건문](#91-조건문)
    - [9.1.1. 조건문 `if`](#911-조건문-if)
      - [9.1.1.1. 예시](#9111-예시)
      - [9.1.1.2. 해설](#9112-해설)
    - [9.1.2. 조건문 `switch`](#912-조건문-switch)
      - [9.1.2.1. `switch`문의 구성](#9121-switch문의-구성)
        - [9.1.2.1.1. `default`](#91211-default)
        - [9.1.2.1.2. `break`](#91212-break)
      - [9.1.2.2. `if`와의 차이점](#9122-if와의-차이점)
  - [9.2. 반복문](#92-반복문)
    - [9.2.1. 반복문 `while`](#921-반복문-while)
      - [9.2.1.1. 사용법](#9211-사용법)
  - [9.3. 반복문 `do~while`](#93-반복문-dowhile)
    - [9.3.1. 사용법](#931-사용법)
      - [9.3.1.1. 예시](#9311-예시)
      - [9.3.1.2. 결과](#9312-결과)
    - [9.3.2. `while`과의 차이점](#932-while과의-차이점)
    - [9.4. 반복문 `for`](#94-반복문-for)
    - [9.4.1. 사용법](#941-사용법)
      - [9.4.1.1. 예시](#9411-예시)
      - [9.4.1.2. 결과](#9412-결과)
- [10. 배열](#10-배열)
  - [10.1. 배열 선언 방법](#101-배열-선언-방법)
  - [10.2. 배열명 생성](#102-배열명-생성)
    - [10.2.1. 인덱스(index)란?](#1021-인덱스index란)
    - [10.2.2. 엘리멘트(element)란?](#1022-엘리멘트element란)
    - [10.2.3. 배열 길이가 10일때](#1023-배열-길이가-10일때)
      - [10.2.3.4. 예시](#10234-예시)
  - [10.3 배열의 길이](#103-배열의-길이)
  - [10.4. 배열의 초기화](#104-배열의-초기화)
    - [10.4.1. 예시](#1041-예시)
    - [10.4.2. 결과](#1042-결과)
  - [10.5. 배열의 특징](#105-배열의-특징)
    - [10.5.1. 특징 1](#1051-특징-1)
      - [10.5.1.1. 예시: 일반적인 배열 초기화 방법](#10511-예시-일반적인-배열-초기화-방법)
      - [10.5.1.2. 예시: 배열이 너무 많을 때 초기화 방법](#10512-예시-배열이-너무-많을-때-초기화-방법)
    - [10.5.2. 특징 2](#1052-특징-2)
      - [10.5.2.1. 예시](#10521-예시)
    - [10.5.3. 특징 3](#1053-특징-3)
    - [10.5.4. 특징 4](#1054-특징-4)
</details>
<br>
<br>
...
이렇게 가정했을 때, `a & b`는 어떤 결과를 내놓는가?

가상의 값 `c`가 있다고 해보자. 이 `c`에 `a & b`를 대입해보도록 하자.
...
여기에서 알 수 있는 것은, 비트연산자는 각 자리와 같은 자리에 위치한 비트끼리를 비교해서 결과를 내놓는다는 것이다.
